process ML_SEGMENTATIONNUCLEUSVECTORFIELDTILES {
    tag "$meta"
    ...
    script:
    output_dir = "${meta}_segmentation_nucleus_vector_field_tiles"
    """
        feature_segmentation_nucleus_vector_field_tiles.py generate_data_array \\
